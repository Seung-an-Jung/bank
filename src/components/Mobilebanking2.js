...
//            },
    ...
    return (
        <div className="Container">
            <h2> 선택하신 만족도가 높은 은행별 모바일뱅킹 순위표입니다</h2>
            <Container>
