...
function Mobilebanking3(props) {
    ...
    const [val2_kakao, setKakaoVal2] = useState(location.state.val_kakao)
    const [val2_kb, setKbVal2] = useState(location.state.val_kb)
    const [val2_nh, setNhVal2] = useState(location.state.val_nh)
    const [val2_sinhan, setSinhanVal2] = useState(location.state.val_sinhan)
    const [val2_woori, setWooriVal2] = useState(location.state.val_woori)
    const [val2_ibk, setIbkVal2] = useState(location.state.val_ibk)
    const [val2_hana, setHanaVal2] = useState(location.state.val_hana)
        ...
        scales: {
            ...
            y: {
                ...
                title: {
                    ...
                    text: '단위: 2020년 11월 기준 사용자수(Blue)',
                },
            },
           y_sub: {
              position: 'right',
