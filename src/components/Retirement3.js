...
function Retirement3(props) {
    ...
    var data = {
        ...
        datasets: [
            ...
            {
                 type: 'bar',
                 label: '수수료율이 높을 수록 낮은순위임             출처: 금융감독원',
    ...
    return (
        <div className="Container">
            <h2>
                본 페이지는 연금저축의 수익률과 수수료율을 모두 중시하는 경우 순위표입니다.
            </h2>
           <Container>
