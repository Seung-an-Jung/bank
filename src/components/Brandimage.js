    ...
    function get_Brandimage() {
        fetch('http://localhost:3001/get_Brandimage', {
            ...
            .then((json) => {
                ...
                calculate(json, location.state.value5)
            })
    }
            ...
            <div class="nav">
                <ul>
                    ...
                    <li2>
                        ...
                        <h4> 한국기업평판연구소가 산정한 여러기준에 따른
                        </h4>
                        
                        <h4>     
                        브랜드점수를 은행의 전반적인 평판/인식으로 판단함
                        </h4>
                    </li2>
                </ul>
            </div>
